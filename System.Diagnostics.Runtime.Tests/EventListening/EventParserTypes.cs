...
public class EventParserTypesTests
{
    ...
    public class AllEvents : AllEvents.Events.Info, AllEvents.Events.Warning, AllEvents.Events.Error, AllEvents.Events.Always, AllEvents.Events.Counters, AllEvents.Events.Critical, IEvents
    {
