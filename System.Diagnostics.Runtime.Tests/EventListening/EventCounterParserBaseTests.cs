...
public class Given_An_Implementation_Of_EventCounterParserBaseTest_That_Has_No_Decorated_Events
{
    ...
    public class NoAttributesEventCounterParser : EventCounterParserBase<NoAttributesEventCounterParser>, ITestCounters
    {
        public override string EventSourceName => "Test";
        public override EventKeywords Keywords { get; }
        public override int RefreshIntervalSeconds { get; set; }

        public event Action<IncrementingCounterValue> TestIncrementingCounter = _ => { };
        public event Action<MeanCounterValue> TestMeanCounter = _ => { };
    }
}
...
{
    private DummyTypeEventCounterParser _parser = default!;
    ...
    public class DummyTypeEventCounterParser : EventCounterParserBase<DummyTypeEventCounterParser>, ITestCounters
    {
        public override string EventSourceName => "Test";
        public override EventKeywords Keywords { get; }
        public override int RefreshIntervalSeconds { get; set; }
...
public interface ITestCounters : ICounterEvents
{
